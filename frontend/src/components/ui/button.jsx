  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        glass:
          "bg-card/60 backdrop-blur-md border border-border/50 text-foreground shadow-glass hover:bg-card/80 hover:shadow-lg hover:-translate-y-0.5 active:translate-y-0",
        primary:
          "bg-gradient-to-r from-primary to-accent text-primary-foreground shadow-md hover:shadow-glow hover:-translate-y-0.5 active:translate-y-0 border border-white/20",
        suggestion:
          "bg-secondary text-secondary-foreground border border-border/50 hover:bg-primary-light hover:border-primary/30 hover:text-primary rounded-full",
      },
      size: {
